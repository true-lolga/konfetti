...
function wppano_JS_OnNewPano(vtour_name, pano, scene) {
	jQuery('#pano_name').val(pano);
	jQuery('#scene_name').val(scene);
	jQuery('#vtourname').val(vtour_name);	
	...
	jQuery('.hotspot_element').each(function() {
		...
		if (_this.attr('scene_name') != scene || _this.attr('pano_name') != pano) {
			...
			visible = true;
			krpano.set('cms.post_title', post_title.val());
			krpano.call("wppano_Adminwppano_AddNewHotspot("+post_id.val()+", "+_this.attr('ath')+", "+_this.attr('atv')+", '"+_this.attr('hs_style')+"')");
...
jQuery(document).ready(function(){
		...
		jQuery.ajax({
			...
			success: function(response){
				...
				if(result.type == "success") {
					...
					krpano.set('cms.post_title', post_title.val());
					krpano.call("wppano_Adminwppano_AddNewHotspot("+post_id.val()+", "+ath.val()+", "+atv.val()+", '"+style.val()+"')");					
	...
	jQuery('.wppano_UpdateHotspot').live("click", function(){
		var _this = jQuery(this);
	...
	jQuery('.wppano_DeleteHotspot').live("click", function(){
		var _this = jQuery(this);
		var container = _this.closest('.hotspot_element');
		var vtourname = jQuery('#vtourname');
		jQuery.ajax({
	...
	jQuery('.SearchHotspot').live("click", function(){
		var _this = jQuery(this);
		var container = _this.closest('.hotspot_element');
		var pano_name = jQuery('#pano_name');
		var scene_name = jQuery('#scene_name');
